...
mongoc_matcher_t * generate_matcher_from_json(const uint8_t *buf_spec, uint32_t  len_spec);
...
bson_t *           generate_doc_from_json(const uint8_t *buf_doc, uint32_t len_doc);
...
char *             bsonsearch_project_json(mongoc_matcher_t *matcher,  bson_t  *bson);
char *             bsonsearch_project_canonical_json(mongoc_matcher_t *matcher,  bson_t  *bson);
