 ...
 * Mongolite Aliases
 *
 * Provide MONGOLITE_* aliases for wtree3 macros for backwards
 * compatibility with existing mongolite code.
 * ============================================================ */

#define MONGOLITE_LIKELY(x)         WTREE_LIKELY(x)
#define MONGOLITE_UNLIKELY(x)       WTREE_UNLIKELY(x)
#define MONGOLITE_PURE              WTREE_PURE
#define MONGOLITE_CONST             WTREE_CONST
#define MONGOLITE_MALLOC            WTREE_MALLOC
#define MONGOLITE_NONNULL(...)      WTREE_NONNULL(__VA_ARGS__)
#define MONGOLITE_NONNULL_ALL       WTREE_NONNULL_ALL
#define MONGOLITE_RETURNS_NONNULL   WTREE_RETURNS_NONNULL
#define MONGOLITE_WARN_UNUSED       WTREE_WARN_UNUSED
#define MONGOLITE_HOT               WTREE_HOT
#define MONGOLITE_COLD              WTREE_COLD
#define MONGOLITE_FLATTEN           WTREE_FLATTEN
#define MONGOLITE_ALWAYS_INLINE     WTREE_ALWAYS_INLINE
#define MONGOLITE_NOINLINE          WTREE_NOINLINE
#define MONGOLITE_ALIGNED(n)        WTREE_ALIGNED(n)
#define MONGOLITE_PACKED            WTREE_PACKED
#define MONGOLITE_PREFETCH(a,r,l)   WTREE_PREFETCH(a,r,l)
#define MONGOLITE_RESTRICT          WTREE_RESTRICT
#define MONGOLITE_UNREACHABLE()     WTREE_UNREACHABLE()
#define MONGOLITE_ASSUME(cond)      WTREE_ASSUME(cond)
#define MONGOLITE_CHECK(cond)       WTREE_CHECK(cond)
#define MONGOLITE_SUCCESS(cond)     WTREE_SUCCESS(cond)
